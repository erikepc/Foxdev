...
public class AppDbSeed
{
    ...
    public void SeedQuestoes()
    {
        List<Questao> _todasAsQuestoes = new List<Questao>
        {
            ...
            new Questao { Id = 101, LicaoId = 1, Enunciado = "Para declarar uma variável em C#, usamos a palavra-chave ____.", RespostaCorreta = "var", Tipo = QuestionType.FillInTheBlank },
