...
public class AppDbSeed
{
    ...
    public void SeedQuestoes()
    {
        List<Questao> _todasAsQuestoes = new List<Questao>
        {
            ...
            new Questao { Id = 4, LicaoId = 1, Enunciado = "Complete a linha de código que declara uma variável do tipo string chamada nome:", RespostaA = "string = nome;", RespostaB = "nome string = \"João\";", RespostaC = "string nome = \"João\";", RespostaD = "var: nome = \"João\";", RespostaCorreta = "C", Tipo = QuestionType.MultipleChoice },
            ...
            new Questao { Id = 7, LicaoId = 1, Enunciado = "Qual opção completa corretamente a atribuição abaixo?\nint idade;\n______", RespostaA = "idade = 25;", RespostaB = "idade := 25;", RespostaC = "idade == 25;", RespostaD = "idade => 25;", RespostaCorreta = "A", Tipo = QuestionType.MultipleChoice },
            ...
            new Questao { Id = 10, LicaoId = 1, Enunciado = "Complete o código para declarar uma variável booleana chamada ativo como verdadeira:\n______ ativo = true;", RespostaA = "boolean", RespostaB = "bool", RespostaC = "logic", RespostaD = "true", RespostaCorreta = "B", Tipo = QuestionType.MultipleChoice },
